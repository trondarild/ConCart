...
3. Implements functions to find structural patterns ("lenses") and to query for all connections from a specific object.
...
function main()
    ...
    # --- NEW: Example 3: Find all direct connections from a specific object ---
